...
>
  ...
  <div class="w-3/4 sm:w-1/2 container mx-auto mt-4">
    <div class="carousel sm:h-3/4">
      <div id="item1" class="carousel-item w-full">
        <img src="https://picsum.photos/200" class="w-full" alt="" />
      </div>
      <div id="item2" class="carousel-item w-full">
        <img src="https://picsum.photos/201" class="w-full" alt="" />
      </div>
      <div id="item3" class="carousel-item w-full">
        <img src="https://picsum.photos/202" class="w-full" alt="" />
      </div>
